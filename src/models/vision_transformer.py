...
class VisionTransformer(nn.Module):
    ...
    def __init__(
        ...
        drop_rate=0.0,
        attn_drop_rate=0.0,
        drop_path_rate=0.0,                             #NOTE: For stochastic depth, the drop path rate is the probability of dropping a path (not used in the paper)
        ...
        use_rope=False,                                 #NOTE: For paper implementation this should be True
        ...
        **kwargs
        ...
        self.img_height, self.img_width = img_size                          #NOTE: Image size is a list of two integers, height and width
    ...
    def _init_pos_embed(self, pos_embed):
        ...
        grid_size = self.img_height // self.patch_size  # TODO: update; currently assumes square input (from meta)
        if self.is_video:
